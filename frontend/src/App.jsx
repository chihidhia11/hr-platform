    ...
    <div>
      <nav className="navbar">
        <Link to="/" style={{
          ...
          textDecoration: 'none', marginRight: '8px', flexShrink: 0
        }}>
          HR<span style={{ color: 'var(--primary)' }}>Platform</span>
        </Link>

        <div style={{ width: '1px', height: '20px', background: 'var(--border)', marginRight: '8px', flexShrink: 0 }} />
          ...
          {user ? (
            <>
              ...
              <Link to="/profile" style={{
                ...
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--primary)'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(37,99,235,0.1)'; }}
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: '13px', fontWeight: 600, boxShadow: 'none',
                  borderRadius: 'var(--r-sm)'
                }}
                onMouseEnter={e => { e.currentTarget.style.background = 'var(--navy)'; e.currentTarget.style.color = 'white'; e.currentTarget.style.borderColor = 'var(--navy)'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
                onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = 'var(--text-muted)'; e.currentTarget.style.borderColor = 'var(--border)'; e.currentTarget.style.transform = 'translateY(0)'; }}
              >
                Logout
              </button>
            </>
            ...
            <>
              <Link to="/login" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--text-muted)', padding: '7px 14px', borderRadius: 'var(--r-sm)', transition: 'all 0.15s' }}>
                Sign In
              </Link>
              <Link to="/register" style={{
                background: 'linear-gradient(135deg, var(--primary), #1D4ED8)',
                color: 'white', padding: '8px 18px', borderRadius: 'var(--r-sm)',
