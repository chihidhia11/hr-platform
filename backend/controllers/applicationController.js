...
exports.scheduleInterview = async (req, res) => {
  try {
    ...
    try {
      ...
      console.log('Interview email failed (continuing):', emailError.message);
    }
...
// CANDIDATE responds to interview (confirm or cancel)
exports.respondToInterview = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: `Interview ${status}`, application });
